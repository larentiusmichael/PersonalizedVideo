...
const flowersPath = "../assets/flowers.png";
const butterfly1Path = "/assets/butterfly1.gif";
const butterfly2Path = "/assets/butterfly2.gif";
...
const flowersBackground: React.CSSProperties = {
  ...
  width: "100%",
  height: "100%",
  backgroundImage: `url(${flowersPath})`,
...
// Keyframes for butterfly animations
...
// Style for the red line below titleText3
