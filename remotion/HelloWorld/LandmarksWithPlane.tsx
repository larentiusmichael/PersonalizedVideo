...
const planePath = "../assets/plane.png";
const landmarksPath = "/assets/landmarks.png";
...
const landmarksBackground: React.CSSProperties = {
  ...
  backgroundImage: `url(${landmarksPath})`,
  ...
  return (
    ...
    >
      ...
      <div style={planeAnimationStyle}>
        <img src={planePath} alt="Plane flying" style={{ width: "100%" }} />
      </div>
