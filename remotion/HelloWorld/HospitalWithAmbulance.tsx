...
const hospitalPath = "../assets/hospital.png";
const hillsPath = "/assets/hills.png";
const carPath = "/assets/car.gif";
...
const hospitalBackground: React.CSSProperties = {
  ...
  width: "40%",
  height: "80%",
  backgroundImage: `url(${hospitalPath})`,
  backgroundSize: "cover",
  backgroundPosition: "center",
  zIndex: 2,
};
...
export const HospitalWithAmbulance: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div style={carStyle}>
        <img src={carPath} alt="Car" style={{ width: "100%" }} />
      </div>
